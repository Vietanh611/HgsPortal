...
{
    /// <inheritdoc />
    public partial class AddDisplayDevicesTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnsatisfiedReasons", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckinCounterName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    RatingLevel = table.Column<int>(type: "int", nullable: false),
                    EvaluationType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Evaluations_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalSchema: "CustomerSatisfaction",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Roles_OrganizationUnits_OrganizationUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BravoId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationReasonLinks", x => new { x.EvaluationId, x.ReasonId });
                    table.ForeignKey(
                        name: "FK_EvaluationReasonLinks_Evaluations_EvaluationId",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvaluationReasonLinks_UnsatisfiedReasons_ReasonId",
                        column: x => x.ReasonId,
                        principalSchema: "CustomerSatisfaction",
                        principalTable: "UnsatisfiedReasons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousTokenHash = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleMenus_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMenus_Users_AssignedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationReasonLinks_ReasonId",
                schema: "CustomerSatisfaction",
                table: "EvaluationReasonLinks",
                column: "ReasonId");

            migrationBuilder.CreateIndex(
                name: "IX_Evaluations_DeviceId",
                schema: "CustomerSatisfaction",
                table: "Evaluations",
                column: "DeviceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Roles_OrganizationUnitId",
                table: "Roles",
                column: "OrganizationUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMenus_AssignedBy",
                table: "UserMenus",
                column: "AssignedBy");
