...
public interface IMenuService
{
    ...
    /// <summary>
    /// Trả về danh sách userId nắm một menu code cụ thể (gán trực tiếp UserMenus + kế thừa
    /// RoleMenus), bao gồm cả SUPER_ADMIN vì super admin ngầm có toàn bộ menu. Dùng cho
    /// việc tìm nhóm người nhận thông báo theo quyền menu (chiều ngược với GetEffectiveMenuCodesAsync).
    /// </summary>
    Task<List<int>> GetUserIdsWithMenuCodeAsync(string menuCode, CancellationToken cancellationToken = default);
}
