...
public interface IUsersService
{
    ...
    /// <summary>Mở khóa tài khoản đang bị khóa do đăng nhập sai nhiều lần (xóa LockoutEnd và đếm lỗi để user đăng nhập lại ngay); bắt buộc user thuộc phạm vi tổ chức của caller.</summary>
